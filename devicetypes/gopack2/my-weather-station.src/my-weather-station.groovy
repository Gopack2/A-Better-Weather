...
*/
metadata {
    definition (name: "My Weather Station", namespace: "gopack2", author: "Gopack2") {
        ...
        attribute "zipcode1", "string"
        command "refresh"
    }

    preferences {
        input "zipCode1", "text", title: "Zip Code (optional)", required: false
        input "zipCode2", "text", title: "Zip Code (optional)", required: false
        input "zipCode3", "text", title: "Zip Code (optional)", required: false
    ...
    tiles(scale: 2) {
        multiAttributeTile(name:"temperature", type:"generic", width:6, height:4, canChangeIcon: false) {
            ...
            tileAttribute("device.feelsLike", key: "PRINARY_CONTROL") {
       ...
       multiAttributeTile(name:"city2", type:"generic", width:6, height:3, canChangeIcon: false) {
            tileAttribute("device.city", key: "PRIMARY_CONTROL") {
                attributeState("temperature",label:'${currentValue}°',
					backgroundColors:[
					[value: 32, color: "#153591"],
					[value: 44, color: "#1e9cbb"],
		 ...
		 main(["temperature2"])
        details(["temperature","feelslike", "weatherIcon", "weather", "humidity" , "dewpoint", "windinfo", "pressure", "solarradiation", "uv_index", "light", "visibility", "rise", "set", "lastSTupdate", "percentPrecip", "percentPrecipToday", "percentPrecipLastHour", "water", "alert", "refresh", "city"])
}
...
private get(feature) {
    getWeatherFeature(feature, zipCode1)
}
