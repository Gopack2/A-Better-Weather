...
metadata {
    definition (name: "A Better Weather Tile 1.1", namespace: "Gopack2", author: "Gopack2") {
        ...
        //-------------------------------------------------------
        attribute "forecastDay0High","string"
        attribute "forecastDay0Low","string" 
        attribute "forecastDay0Conditions","string"
        attribute "forecastDay0qpf_AllDay","string"
        attribute "forecastDay0qpf_Day","string"
        attribute "forecastDay0qpf_Night","string"
        attribute "forecastDay0Snow_AllDay","string"
        attribute "forecastDay0Snow_Day","string"
        attribute "forecastDay0Snow_Night","string"
        attribute "forecastDay0MaxWind","string"
        attribute "forecastDay0MaxWindDir","string"
        attribute "forecastDay0MaxWindDeg","string"
        attribute "forecastDay0AveWind","string"
        attribute "forecastDay0AveWindDir","string"
        attribute "forecastDay0AveWindDeg","string"
        attribute "forecastDay0AveHumidiy","string"
        attribute "forecastDay1High","string"
        attribute "forecastDay1Low","string" 
        attribute "forecastDay1Conditions","string"
        attribute "forecastDay1qpf_AllDay","string"
        attribute "forecastDay1qpf_Day","string"
        attribute "forecastDay1qpf_Night","string"
        attribute "forecastDay1Snow_AllDay","string"
        attribute "forecastDay1Snow_Day","string"
        attribute "forecastDay1Snow_Night","string"
        attribute "forecastDay1MaxWind","string"
        attribute "forecastDay1MaxWindDir","string"
        attribute "forecastDay1MaxWindDeg","string"
        attribute "forecastDay1AveWind","string"
        attribute "forecastDay1AveWindDir","string"
        attribute "forecastDay1AveWindDeg","string"
        attribute "forecastDay1AveHumidiy","string"
        attribute "forecastDay2High","string"
        attribute "forecastDay2Low","string" 
        attribute "forecastDay2Conditions","string"
        attribute "forecastDay2qpf_AllDay","string"
        attribute "forecastDay2qpf_Day","string"
        attribute "forecastDay2qpf_Night","string"
        attribute "forecastDay2Snow_AllDay","string"
        attribute "forecastDay2Snow_Day","string"
        attribute "forecastDay2Snow_Night","string"
        attribute "forecastDay2MaxWind","string"
        attribute "forecastDay2MaxWindDir","string"
        attribute "forecastDay2MaxWindDeg","string"
        attribute "forecastDay2AveWind","string"
        attribute "forecastDay2AveWindDir","string"
        attribute "forecastDay2AveWindDeg","string"
        attribute "forecastDay2AveHumidiy","string"
        attribute "forecastDay3High","string"
        attribute "forecastDay3Low","string" 
        attribute "forecastDay3Conditions","string"
        attribute "forecastDay3qpf_AllDay","string"
        attribute "forecastDay3qpf_Day","string"
        attribute "forecastDay3qpf_Night","string"
        attribute "forecastDay3Snow_AllDay","string"
        attribute "forecastDay3Snow_Day","string"
        attribute "forecastDay3Snow_Night","string"
        attribute "forecastDay3MaxWind","string"
        attribute "forecastDay3MaxWindDir","string"
        attribute "forecastDay3MaxWindDeg","string"
        attribute "forecastDay3AveWind","string"
        attribute "forecastDay3AveWindDir","string"
        attribute "forecastDay3AveWindDeg","string"
        attribute "forecastDay3AveHumidiy","string"
        //-------------------------------------------------------
    ...
    tiles(scale:2) {
  		multiAttributeTile(name:"temperature", type:"generic", width:1, height:1, canChangeIcon: false) {
	       	tileAttribute("device.tempTile", key: "PRIMARY_CONTROL") {
                ...
                /* tileAttribute("device.tempTileM", key: "PRIMARY_CONTROL") {
                    attributeState("temperature" ,label:'${currentValue}',
                    backgroundColors:[	
               		//Celsius
        ...
        standardTile("alert", "device.alert", inactiveLabel: false, width: 4, height: 2, decoration: "flat", wordWrap: true) {
      		state "[null]",action:"loc3",icon:"https://raw.github.com/Gopack2/A-Better-Weather-Tile-1.0/master/Alert%20Icons/Default.png"
 ...
 main ("temperature2")
      //details(["alert", "loc1","loc2","loc3","loc1Name","loc2Name","loc3Name","temperature", "weatherIcon","weather","humidity" , "dewpoint", "windinfo", "pressure", "solarradiation","light", "city", "rise", "set", "lastSTupdate", "percentPrecip", "PrecipToday","PrecipLastHour", "water", "refresh"])
 		details(["loc1","loc2","loc3","loc1Name","loc2Name","loc3Name","alert","temperature", "weatherIcon","weather","water", "refresh","humidity" ,  "dewpoint", "windinfo", "pressure", "rise", "set", "lastSTupdate", "percentPrecip", "PrecipToday","PrecipLastHour","alertMessage"])
 		}
}
...
sendEvent("name":"Zip","value":location1Zip)
    ...
    sendEvent(name:"ForecastGraphic",value:"https://www.theweather.com/wimages/fotoba7037436d671b4cbf1465324d987c6b.png")
  	switch (runEvery) {       
       	case "1 minute" :
	...
	switch (state.loc1Overide) {
    	case "false":
            ...
            sendEvent(name:"loc1",value: "active" , displayed: false)
             //sendEvent(name:"ForecastGraphic",value:"default")
            poll()
            break;
    	case"true":
            sendEvent(name: "city", "value":location1Name, displayed: false)   
		...
		if (measUnits) {
            switch (measUnits) {
            	case "imperial" :
                        ...
                        if (state.loc1Overide == "true") {
                			send(name: "tempTile", value: "${Temp}°F \n ${obs.display_location.city}" , displayed: false)
                            }
                		else {
...
// Forecast 10 day
 	def f = get("forecast10day")
      ...
      def simpleForecast = get("forecast")?.forecast?.simpleforecast?.forecastday
      
      switch(measUnits) {
                case "imperial" :
               		for(int i = 0;i<4;i++) {	
                        send(name:"forecastDay${i}High", value: "${simpleForecast[i].high.fahrenheit}",unit:"° F",displayed: false)
                        send(name:"forecastDay${i}Low", value: "${simpleForecast[i].low.fahrenheit}",unit:"° F",displayed: false)
                        send(name:"forecastDay${i}Conditions", value: "${simpleForecast[i].conditions}",displayed: false)
                        send(name:"forecastDay${i}qpf_AllDay", value: "${simpleForecast[i].qpf_allday.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}qpf_Day", value: "${simpleForecast[i].qpf_day.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}qpf_Night", value: "${simpleForecast[i].qpf_night.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}Snow_AllDay", value: "${simpleForecast[i].snow_allday.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}Snow_Day", value: "${simpleForecast[i].snow_day.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}Snow_Night", value: "${simpleForecast[i].snow_night.in}",unit:" in",displayed: false)
                        send(name:"forecastDay${i}MaxWind", value: "${simpleForecast[i].maxwind.mph}",unit:" mph",displayed: false)
                        send(name:"forecastDay${i}MaxWindDir", value: "${simpleForecast[i].maxwind.dir}",displayed: false)
                        send(name:"forecastDay${i}MaxWindDeg", value: "${simpleForecast[i].maxwind.degrees}",unit:"°",displayed: false)
                        send(name:"forecastDay${i}AveWind", value: "${simpleForecast[i].avewind.mph}",unit:" mph",displayed: false)
                        send(name:"forecastDay${i}AveWindDir", value: "${simpleForecast[i].avewind.dir}",displayed: false)
                        send(name:"forecastDay${i}AveWindDeg", value: "${simpleForecast[i].avewind.degrees}",unit:"°",displayed: false)
                        send(name:"forecastDay${i}AveHumidiy", value: "${simpleForecast[i].avehumidity}",unit:"%",displayed: false)
	     
     				}
        		break;
                case "metric" :
                for(int i = 0;i<4;i++) {	
                      	send(name:"forecastDay${i}High", value: "${simpleForecast[i].high.celsius}",unit:"° C",displayed: false)
                        send(name:"forecastDay${i}Low", value: "${simpleForecast[i].low.celsius}",unit:"° C",displayed: false)
                        send(name:"forecastDay${i}Conditions", value: "${simpleForecast[i].conditions}",displayed: false)
                        send(name:"forecastDay${i}qpf_AllDay", value: "${simpleForecast[i].qpf_allday.mm}",unit:" mm",displayed: false)
                        send(name:"forecastDay${i}qpf_Day", value: "${simpleForecast[i].qpf_day.mm}",unit:" mm",displayed: false)
                        send(name:"forecastDay${i}qpf_Night", value: "${simpleForecast[i].qpf_night.mm}",unit:" mm",displayed: false)
                        send(name:"forecastDay${i}Snow_AllDay", value: "${simpleForecast[i].snow_allday.cm}",unit:" cm",displayed: false)
                        send(name:"forecastDay${i}Snow_Day", value: "${simpleForecast[i].snow_day.cm}",unit:" cm",displayed: false)
                        send(name:"forecastDay${i}Snow_Night", value: "${simpleForecast[i].snow_night.cm}",unit:" cm",displayed: false)
                        send(name:"forecastDay${i}MaxWind", value: "${simpleForecast[i].maxwind.kph}",unit:" kph",displayed: false)
                        send(name:"forecastDay${i}MaxWindDir", value: "${simpleForecast[i].maxwind.dir}",displayed: false)
                        send(name:"forecastDay${i}MaxWindDeg", value: "${simpleForecast[i].maxwind.degrees}",unit:"°",displayed: false)
                        send(name:"forecastDay${i}AveWind", value: "${simpleForecast[i].avewind.kph}",unit:" kph",displayed: false)
                        send(name:"forecastDay${i}AveWindDir", value: "${simpleForecast[i].avewind.dir}",displayed: false)
                        send(name:"forecastDay${i}AveWindDeg", value: "${simpleForecast[i].avewind.degrees}",unit:"°",displayed: false)
                        send(name:"forecastDay${i}AveHumidiy", value: "${simpleForecast[i].avehumidity}",displayed: false)  
